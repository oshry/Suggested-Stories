var _scq = _scq || [];
_scq.push(['setMerchantId', '1D65D07C79A95245']);
...
var ScarabUtil = function() {
  ...
  mobile:{path:s3Resource("/discodrag/build.js"), devPath:localResource("/dist/build.js"), stagingPath:s3Resource("/discodragstaging/build.js")}, legacyMobile:{path:staticResource("/mobildisco/build.js"), devPath:localResource("/build/build.js")}, moduleConfig:"_scdiscovery", durationSeconds:24 * 60 * 60}, emarsys_webpersonalization:{aliases:["sc_webpersonalization"], es6:{path:cacheBuster(s3Resource("/wpjs/wpes6.js")), devPath:localResource("/dist/wpes6.js")}, es5:{path:cacheBuster(s3Resource("/wpjs/wpes5.js")), 
  devPath:localResource("/dist/wpes5.js")}, loader:{path:cacheBuster(s3Resource("/wpjs/wploader.js")), devPath:localResource("/dist/wploader.js")}, durationSeconds:24 * 60 * 60}, emarsys_instantsearch:{aliases:["sc_instantsearch"], path:s3Resource("/instantsearch/build.js"), devPath:localResource("/dist/build.js"), moduleConfig:"_scinstant", durationSeconds:24 * 60 * 60}, emarsys_webpush:{path:s3Resource("/web-push-client/emarsys-web-push.js"), devPath:localResource("/emarsys-web-push.js"), durationSeconds:24 * 
  60 * 60}};
  ...
  var loadModule = function(w, module, config, subModule, cb) {
    ...
    if (config && config.devSsl) {
      src = paths.devPath.replace(/http:\/\/local.scarabresearch.com:3000/g, "https://dafay6v9gkf6n.cloudfront.net");
    }
